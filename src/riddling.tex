...
The fault is in the wrong working out of the expetency. The $x$ in each option is not the same $x$ since the sums $1/2x$, $x$ and $2x$ do not occur simultaneously. Lets do the calculation more carefully. Will will denote the envelopes with the sums $1/2x$ and $x$. With probability of $1/2$ you got the envelope with $1/2x$ which means you have you have $1/2x$ to gain if you switch. With the same probability of $1/2$ you got the envelope with $x$ in which case you have $1/2x$ to lose if you switch. This means that the expected value of switching is $0$ as it should be. No paradox at all. If we had denoted the two envlopes $x$ and $2x$ we would have got the same result: with probability $1/2$ we got the envelope with $x$ in its and can gain $x$ if we switch. With the same probability we got the envelope with $2x$ and stand to lost $x$ if we switch. The overall expected value is again $0$ as it should be.
