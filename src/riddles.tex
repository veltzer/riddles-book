...
The distance between each two bottles will be $d=\sqrt{2h^2}$.

\begin{center}
\input{out/bottles.tex}
\end{center}

The shape created by the bottle caps is, ofcourse, a perfect triangular pyramid with a side of length $d$.
