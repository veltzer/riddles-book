...
The first is to put the bottles in a square where each the side of the square is the length of the bottle. Bottles
next to each other will stand 'in reverse' (if the first is on it's head the the second will stand straight).
The distance between each two bottles will be $\sqrt{2l^2}$.

The second is to put three bottles on the vertices of an even sided triangle standing one way. The fourth will be placed
