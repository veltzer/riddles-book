...
Now for the first players job. When the first played comes along he will either see all cycles with $size<=50$ in which case he need not do anything (unless he wants to break up the largest cycle to reduce the expected value of urns broken by the second player) or will contend with utmost a single cycle with $size > 50$ which means he needs to break just this one cycle.
